						...
						<td class="product-quantity">
							...
							<div class="quantity__row">
								<div class="quantity">
									...
									<input class="input-text qty text quantity-nu" type="number" min="1" step="1" name="items[<?php echo esc_attr( $item->get_product_id() ); ?>][quantity]" value="<?php echo esc_attr( $item->get_quantity() ); ?>"/>
