							...
							<?php if ( $show_variation || $show_dateadded || $show_price ): ?>
								<table class="item-details-table">
									...
									<?php if ( $show_price || $show_price_variations ) : ?>
										<tr>
											<td class="label">
												<?php the_field('napdpis_czena_ediniczy', 'options');?>
											</td>
											<td class="value">
												<?php
												if ( $show_price ) {
						...
						<?php if ( $show_quantity || $show_stock_status ): ?>
							<table class="additional-info">
								<?php if ( $show_quantity ) : ?>
									<tr>
										<td class="label">
											<?php the_field('nadpis_kolichestvo', 'options');?>
										</td>
										<td class="value">
							...
							<div class="product-remove">
								<a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ); ?>" class="remove_from_wishlist" title="<?php echo esc_html( apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'yith-woocommerce-wishlist' ) ) ); ?>">
									<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
										<rect width="16" height="16" fill="#E5E7E8"></rect>
										<rect x="3.91992" y="4.58276" width="0.939109" height="10.3302" transform="rotate(-45 3.91992 4.58276)" fill="#A6A9AA"></rect>
										<rect x="4.58398" y="11.8879" width="0.939109" height="10.3302" transform="rotate(-135 4.58398 11.8879)" fill="#A6A9AA"></rect>
									</svg>
								</a>
							</div>
						<?php endif; ?>
